...
class Rover:
    ...
    def BlueROV2Navigation(
        ...
        """
        Create a BlueROV2 configuration for navigation experiments.

        The navigation sensors are DVL, IMU, and depth. Pose and Velocity are
        included only when ground-truth logging is requested; controllers and
        estimators must not use them.
        """
        sensors = [
            Sensor.DVL(
                socket="DVLSocket",
